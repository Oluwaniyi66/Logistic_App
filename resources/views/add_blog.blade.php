          ...
          <div class="col-md-6">
            ...
            <div class="card card-info">
              <div class="card-header">
                <h3 class="card-title">Blogs Form</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form class="form-horizontal" method="post" action="" enctype="multipart/form-data">
                ...
                <div class="card-body">
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" name="author" id="inputEmail3" placeholder="author's name">
                      <span>@error('author'){{ $message }}
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <textarea class="form-control" name="content" id="" cols="30" rows="10" id="inputPassword3" placeholder="type content"></textarea>
                        <span>@error('answer'){{ $message }}
