              ...
              <form class="form-horizontal" method="post" action="">
                ...
                <div class="card-body">
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" name="question" id="inputEmail3" placeholder="type question">
                      <span>@error('question'){{ $message }}
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control"  name="answer" id="inputPassword3" placeholder="type answer">
