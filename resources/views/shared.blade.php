...
<!-- Mirrored from kreativdev.com/transpix/transpix/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 19 Nov 2021 13:20:57 GMT -->
<head>
      <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
      <meta http-equiv="X-UA-Compatible" content="IE=edge" />
      <meta http-equiv="X-UA-Compatible" content="ie=edge">
      <meta name="viewport" content="width=device-width, initial-scale=1.0">
      <title>Ropostic - Transport & Logistic HTML Template</title>
      <!-- favicon -->
                        ...
                        <div class="row">
                           <div class="offset-xl-4 col-xl-8 offset-2 col-10">
                              <div class="row">
                                 ...
                                 <div class="col-lg-4">
                                    <a href="/get_qoute" class="boxed-btn"><span>Get a Quote</span></a>
                                 </div>
                              </div>
                           </div>
                        </div>
                           ...
                           <div class="col-lg-9 d-lg-block d-none">
                              <nav class="main-menu" id="mainMenu">
                                 <ul>
                                    ...
                                    <li>
                                       <a href="/get_qoute">Get Quote</a>
                                    </li>
                                    <li>
                                       <a href="/track_parcel">Track Parcel</a>
                                    </li>
                                 </ul>
                              </nav>
                           </div>
       ...
       <footer>
        <div class="container">
           <div class="top-footer">
              <div class="row">
                 <div class="col-xl-4 col-lg-4">
                    ...
                    <p>Ropostic shipping offers a host of logistic management services and supply chain & provide innovative solutions with the best. </p>
                 </div>
                 <div class="offset-xl-1 col-xl-2 col-lg-2">
                    ...
                    <ul class="userful-links">
                       ...
                       <li><a href="/track_parcel">Track Parcel</a></li>
           ...
           <div class="bottom-footer">
              <p class="text-center">© Copyrights 2021 Ropistic. All rights reserved.</p>
           </div>
        </div>
     </footer>
     <!--   footer section end    -->
...
<!-- Mirrored from kreativdev.com/transpix/transpix/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 19 Nov 2021 13:21:07 GMT -->
</html>
